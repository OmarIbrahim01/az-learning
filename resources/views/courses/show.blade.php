    ...
    <div class="container" style="padding-bottom: 115px;">
        ...
        <div class="row portfolio-project">
            ...
            <section>
                ...
                <div class="col-sm-8">
                    <video id="my-video" class="video-js vjs-big-play-centered" controls preload="auto" height="554.018625" style="margin: 0 auto; width: 100%;" 
                      poster="MY_VIDEO_POSTER.jpg" data-setup="{}" >
                        <source src="/storage/courses/{{$course->name}}/{{$course->trailer_url}}" type='video/mp4'>
